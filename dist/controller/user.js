        ...
        profileUpload(req, res, function (err) {
            return __awaiter(this, void 0, void 0, function* () {
                if (err instanceof multer_1.default.MulterError) {
                    ...
                    const decodeddata = yield (utilities_1.utilities === null || utilities_1.utilities === void 0 ? void 0 : utilities_1.utilities.decodeToken(req === null || req === void 0 ? void 0 : req.headers['authorization']));
                    console.log(decodeddata);
                    user_model_1.default === null || user_model_1.default === void 0 ? void 0 : user_model_1.default.findOneAndUpdate({ email: decodeddata === null || decodeddata === void 0 ? void 0 : decodeddata.data }, { profilePhoto: 'http://localhost:3000/uploads/a.png' }).then(data => {
